...
public class ViewGame implements Observateur{
	...
	public ViewGame(Controller controllerGame,Game game){
		...
		text=new JLabel("Current Turn : "+0,JLabel.CENTER);
			...
			try {
				frame.add(new PanelPacmanGame(new Maze("C:\\Users\\IMANE\\eclipse-workspace-dpattern\\PacmanGame\\layout\\bigSafeSearch.lay")));
			} catch (Exception e) {
	...
	public static void choosePacmanLayout(Game game) {
        ...
        JFileChooser mazeFileChooser = new JFileChooser(new java.io.File("..\\layout"));
